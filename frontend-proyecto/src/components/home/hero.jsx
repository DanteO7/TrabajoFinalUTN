  ...
  return (
    <section className="bg-red-300 w-full h-137.5">
      <div className="flex flex-col justify-center h-full p-8 gap-5 md:p-40 lg:pr-100">
        ...
        <button
          onClick={onOpenModal}
          className="w-fit text-[#efefef] bg-[#333] rounded-[14px] px-5 py-2 cursor-pointer border-[1.7px] border-[#333] hover:bg-gray-300 hover:text-[#333] hover:border-gray-400 transition duration-300"
        >
          Contratar ahora
        </button>
      </div>
